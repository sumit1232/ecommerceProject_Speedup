...
<nav className="bg-white border-b">
  <div className="container mx-auto flex items-center justify-between px-4 py-3">
    ...
    <ul className="flex space-x-6">
      ...
      <li><a href="/computers" className="hover:text-blue-600">Computers</a></li>
      <li><a href="/headphones" className="hover:text-blue-600">Headphones</a></li>
      <li><a href="/contactus" className="hover:text-blue-600">Contact</a></li>
    </ul>
